...
public class ItemNameContainsIgnoreCase implements Requirement {
	...
	public String getIdentifier() {
		return "itemname contains ignorecase";
	}
	...
	public boolean passesRequirement(Player player, ItemStack item)
	{
		...
		if(item.hasItemMeta())
			...
			{
				return item.getItemMeta().getDisplayName().toLowerCase().contains(val.toLowerCase());
			}
			else
			{
