...
public class ItemNameEqualsIgnoreCase implements Requirement {
	...
	public String getIdentifier() {
		return "itemname equals ignorecase";
	}
	...
	public boolean passesRequirement(Player player, ItemStack item)
	{
		...
		if(item.hasItemMeta())
			...
			{
				return item.getItemMeta().getDisplayName().toLowerCase().equals(val.toLowerCase());
			}
			else
			{
